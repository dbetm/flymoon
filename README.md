...
4) (Optional) Set `AUTO_REFRESH_INTERVAL_MINUTES` to configure the default auto-refresh polling interval. Default is 10 minutes. Recommended range: 5-10 minutes for continuous monitoring.
